...
from hulluedit.eval.eval_chair import compute_chair_metrics
...
def main():
    ...
    parser.add_argument("--input", type=str,
                       default=str(project_root / "outputs" / "chair" / "chair_captions_hulluedit_val.jsonl"),
    ...
    parser.add_argument("--cache", type=str, 
                       default=str(project_root / "outputs" / "chair" / "chair.pkl"),
    ...
    # Set NLTK data path
    os.environ.setdefault("NLTK_DATA", str(project_root / "DATA" / "nltk_data"))
